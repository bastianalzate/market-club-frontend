            ...
            >
              ...
              >
                <div className="flex items-center justify-between mb-0 sm:mb-3">
                  {(product.product_specific_data?.packaging_type || product.product_specific_data?.volume_ml) && (
                    <span
                      className="text-xs text-gray-600 font-medium sm:text-sm"
                      style={{ fontFamily: "var(--font-lato)" }}
                    >
                      {product.product_specific_data?.packaging_type && product.product_specific_data?.volume_ml
                        ? `${product.product_specific_data.packaging_type.toUpperCase()} ${product.product_specific_data.volume_ml}`
