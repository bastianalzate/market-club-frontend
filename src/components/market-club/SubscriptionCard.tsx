...
export default function SubscriptionCard({
  ...
  return (
    <div className={`bg-white rounded-lg overflow-hidden max-w-5xl mx-auto ${className}`}>
      <div className={`flex flex-col md:flex-row ${!isImageLeft ? 'md:flex-row-reverse' : ''}`}>
        ...
        <div className="md:w-1/2 p-10 md:p-12">
          ...
          <button
            className="px-8 py-3 text-white rounded-md font-medium hover:opacity-90 transition-opacity"
            style={{
