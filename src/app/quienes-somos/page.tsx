...
import { Beer, Users, Heart, Star, Quote, Sparkles, Trophy, Smile } from "lucide-react";
...
export default function QuienesSomosPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-black overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-yellow-500/10 backdrop-blur-sm border border-yellow-500/20 rounded-full px-6 py-3 mb-8">
              <Beer className="w-5 h-5 text-yellow-500" />
              <span className="text-yellow-500 font-medium">Nuestra Historia</span>
            </div>
            <h1 
            ...
            <p className="text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Más que cerveza, somos el punto de encuentro donde cada momento se vive mejor
            </p>
            <div className="flex items-center justify-center gap-3 mt-12">
              <div className="w-16 h-1 bg-yellow-500 rounded-full"></div>
              <Beer className="w-6 h-6 text-yellow-500" />
              <div className="w-16 h-1 bg-yellow-500 rounded-full"></div>
            </div>
          </div>
        </div>
      ...
      {/* Nuestra Historia - Diseño más dinámico */}
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 bg-yellow-50 rounded-full px-4 py-2 mb-4">
                  ...
                  <span className="text-yellow-900 font-medium text-sm">Desde el corazón</span>
                </div>
                
                <p className="text-2xl lg:text-3xl text-gray-900 leading-relaxed font-semibold">
                ...
                <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                  ...
                  <p>
                    El nombre <span className="font-bold text-gray-900">Market Club</span> nació inspirado en <span className="font-bold text-yellow-600">Club Colombia</span>, una de las cervezas que más han acompañado los buenos momentos de los colombianos.
                  </p>
                  <p>
                    Pero no queríamos ser sólo una bebida, sino todo lo que pasa alrededor de ella: las charlas con los parceros, los brindis, la energía del partido, los días de sol y los planes que simplemente fluyen.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-3xl p-10 lg:p-12 text-white shadow-2xl transform hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="space-y-6 text-center">
                    <p className="text-lg leading-relaxed">
                      Así, Market Club se volvió <span className="font-bold">más que una marca</span>: un punto de encuentro, un espacio para compartir, reírse y desconectarse del día a día.
                    </p>
                    <p className="text-lg leading-relaxed">
      ...
      {/* Lo que nos hace únicos - Diseño mejorado */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-white rounded-full px-6 py-3 mb-6 shadow-sm border border-gray-200">
                ...
                <span className="text-gray-900 font-medium">Nuestra Esencia</span>
              </div>
              <h2 
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Tres pilares que definen la experiencia Market Club
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-20">
              ...
              <div className="group bg-white rounded-3xl p-10 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-3xl p-12 lg:p-20 text-white text-center overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto">
                  <div className="inline-flex items-center justify-center w-24 h-24 bg-yellow-500 rounded-full mb-10 shadow-2xl">
                  ...
                  <p 
                    ...
                    style={{ fontFamily: 'var(--font-oswald)' }}
                  >
                    No somos un bar cualquiera: Somos el club donde cada cerveza tiene su momento, y cada momento tiene su cerveza.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 lg:py-32 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-6xl mx-auto">
            {/* Header */}
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-yellow-50 rounded-full px-6 py-3 mb-6 border border-yellow-200">
                <Smile className="w-5 h-5 text-yellow-600" />
                <span className="text-yellow-900 font-medium">El alma de Market</span>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-2 lg:order-1">
                <div className="relative">
                  <div className="absolute -top-4 -left-4 w-32 h-32 bg-yellow-500/20 rounded-full blur-2xl"></div>
                  <div className="relative bg-gradient-to-br from-yellow-500 via-yellow-600 to-yellow-700 rounded-3xl p-16 text-white text-center shadow-2xl transform hover:scale-105 transition-transform duration-300">
                    ...
                    <p className="text-2xl font-medium">El corazón de Market Club</p>
              ...
              <div className="order-1 lg:order-2 space-y-6">
                ...
                <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                  <p className="text-xl">
                    Si has pasado por Market Club, <span className="font-bold text-gray-900">seguro ya lo conocés.</span>
                  </p>
                  <p>
                ...
                <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-2xl p-8 mt-10 border-l-4 border-yellow-500 shadow-lg">
                  <div className="flex items-start gap-4">
                    <Quote className="w-8 h-8 text-yellow-600 flex-shrink-0 mt-1" />
                    <p className="text-xl font-semibold text-gray-900 leading-relaxed">
                      Porque en Market Club no solo servimos cerveza, servimos momentos, y con Beto ahí —como siempre— pa' que cada uno sea especial.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-yellow-500/10 backdrop-blur-sm border border-yellow-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-yellow-500 font-medium">Empieza tu experiencia</span>
            </div>
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Descubre nuestras cervezas importadas, arma tu regalo perfecto y únete al club donde cada momento cuenta
            </p>
            
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <a
                href="/tienda"
                className="group inline-flex items-center justify-center gap-3 px-10 py-5 bg-yellow-500 text-black font-bold text-lg rounded-2xl hover:bg-yellow-400 transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-yellow-500/50 cursor-pointer"
                style={{ fontFamily: 'var(--font-oswald)' }}
              >
              ...
              <a
                href="/arma-tu-regalo"
                className="group inline-flex items-center justify-center gap-3 px-10 py-5 bg-transparent border-2 border-yellow-500 text-yellow-500 font-bold text-lg rounded-2xl hover:bg-yellow-500 hover:text-black transition-all duration-300 transform hover:scale-105 cursor-pointer"
                style={{ fontFamily: 'var(--font-oswald)' }}
              >
